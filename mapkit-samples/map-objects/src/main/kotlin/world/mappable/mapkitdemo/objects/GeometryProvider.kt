...
object GeometryProvider {
    ...
    val startPosition = CameraPosition(Point(25.194113, 55.274531), 15f, 0f, 0f)

    val compositeIconPoint = Point(25.188413, 55.282270)

    val animatedImagePoint = Point(25.185632, 55.280006)
