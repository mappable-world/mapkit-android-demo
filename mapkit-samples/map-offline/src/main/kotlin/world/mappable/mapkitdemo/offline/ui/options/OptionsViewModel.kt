package world.mappable.mapkitdemo.offline.ui.options
...
import world.mappable.mapkit.offline_cache.DataMoveListener
import world.mappable.mapkit.offline_cache.OfflineCacheManager.PathSetterListener
...
class OptionsViewModel(context: Context) : ViewModel() {
    ...
    sealed interface MovePathState {
        ...
        data class Error(val error: world.mappable.runtime.Error) : MovePathState
    }
    ...
    sealed interface PathSetState {
        ...
        data class Error(val error: world.mappable.runtime.Error) : PathSetState
    }
